...
func to_ledger(entries):
	for ent in entries:
		...
		if !account_titles.has(ent.debit_title):
			account_titles.append(ent.debit_title)
		elif ent.debit_title == "":
			pass
			
		if !account_titles.has(ent.credit_title):
			account_titles.append(ent.credit_title)
		elif ent.debit_title == "":
			pass
